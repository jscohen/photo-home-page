...
echo '<script src="js/login_tabs.js"></script>';
}
else {
...
<div id="tabs">
  ...
  <div id="tabs-1" class="selected">
    ...
    <p class="thumbs">
	  ...
	  <a href="img/beijing/forbiddencity032.jpg" class="lytebox" data-lyte-options="group:beijing" data-title="A Wall in the Forbidden City"><img class="thumb" src="img/thumbs/forbiddencity_032_thumb.jpg" alt="A Wall in the Forbidden City" /></a>
  ...
  <div id="tabs-2">
    ...
    <p class="thumbs">
	  ...
	  <a href="img/hangzhou/huangshan_zhaopian046.jpg" class="lytebox" data-lyte-options="group:hangzhou" data-title="The misty Yellow Mountains, Anhui Province, China"><img class="thumb" src="img/thumbs/huangshan_zhaopian046_thumb.jpg" alt="The misty Yellow Mountains, Anhui, China" /></a>
	  ...
	  <a href="img/hangzhou/IMG_0605.JPG" class="lytebox" data-lyte-options="group:hangzhou" data-title="A boat on the West Lake, Hangzhou"><img class="thumb" src="img/thumbs/IMG_0605_thumb.jpg" alt="A boat on the West Lake in Hangzhou" /></a>
  ...
  <div id="tabs-3">
    ...
    <p class="thumbs">
	  ...
	  <a href="img/tibet/IMG_1333.JPG" class="lytebox" data-lyte-options="group:tibet" data-title="The fortress of Shigatse, Tibet, overlooking grassland"><img class="thumb" src="img/thumbs/IMG_1333_thumb.jpg" alt="Fortress and Grassland, Shigatse, Tibet" /></a>
  ...
  <div id="tabs-4">
	...
	<p class="thumbs">
	  ...
	  <a href="img/xinjiang/xj_037.jpg" class="lytebox" data-lyte-options="group:xinjiang" data-title="Desert Dunes, Taklamakan, Xinjiang"><img class="thumb" src="img/thumbs/xj_038_thumb.jpg" alt="The Taklamakan Desert, Western Xinjiang 2" /></a>
	  ...
	  <a href="img/xinjiang/xj_042.jpg" class="lytebox" data-lyte-options="group:xinjiang" data-title="A lone rider on Tashkurgan Lake near Kyrgyzstan, Xinjiang"><img class="thumb" src="img/thumbs/xj_042_thumb.jpg" alt="A lone rider on lake Tashkurgan near the Kyrgyz border" /></a>
